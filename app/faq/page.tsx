                    ...
                    <details key={item.q} className="card-glass rounded-2xl p-5 open:shadow-lg">
                      ...
                      <div className="mt-3 space-y-3 text-white/85">
                        ...
                        {item.q.includes("quartiers") && (
                          <p className="text-sm text-white/70">
                            Utile :{" "}
                            <a className="underline text-accent" href="/devis-demenagement-toulouse-capitole-toulouse/">Capitole</a>,{" "}
                            <a className="underline text-accent" href="/devis-demenagement-toulouse-saint-cyprien-toulouse/">Saint-Cyprien</a>,{" "}
                            <a className="underline text-accent" href="/devis-demenagement-toulouse-carmes-toulouse/">Carmes</a>.
                          </p>
                        )}

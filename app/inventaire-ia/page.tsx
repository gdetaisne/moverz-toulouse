...
export default function InventaireIAPage() {
  ...
  return (
    <div className="min-h-screen bg-[#04163a]">
            ...
            <div className="hidden sm:block">
              <div className="flex flex-col items-end space-y-2">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-lg font-semibold text-[#6bcfcf]">Moverz</span>
                </div>
            ...
            <ol className="flex items-center space-x-4">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-4 text-sm font-medium text-white/80">Inventaire</span>
                </div>
              </li>
            </ol>
          </nav>
      ...
      {/* Main content - Iframe IA */}
      <div className="container max-w-7xl mx-auto px-4 md:px-6 py-8">
        <MovingAnalyzer
          title="🤖 Inventaire - toulouse"
          description="Analysez automatiquement vos objets pour un déménagement optimisé à toulouse"
        />
      </div>

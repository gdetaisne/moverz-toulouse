...
export default function NeighborhoodsTeaser() {
  ...
  const picks = [
    { title: "Capitole", href: "/toulouse/capitole-toulouse" },
    { title: "Carmes", href: "/toulouse/carmes-toulouse" },
    { title: "Compans-Caffarelli", href: "/toulouse/compans-caffarelli-toulouse" },
    { title: "Saint-Aubin", href: "/toulouse/saint-aubin-toulouse" },
    { title: "Saint-Cyprien", href: "/toulouse/saint-cyprien-toulouse" },
  ];

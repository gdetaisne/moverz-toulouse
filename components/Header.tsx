...
export default function Header() {
  ...
  const zonesItems = [
    ...
    { href: '/toulouse/capitole-toulouse', label: 'Capitole' },
    { href: '/toulouse/saint-cyprien-toulouse', label: 'Saint-Cyprien' },
    { href: '/toulouse/carmes-toulouse', label: 'Carmes' },
    { href: '/toulouse/saint-aubin-toulouse', label: 'Saint-Aubin' },
    { href: '/toulouse/compans-caffarelli-toulouse', label: 'Compans-Caffarelli' },
  ];

  return (
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-white/5 border-b border-white/10">
      <div className="container max-w-7xl mx-auto px-4 md:px-6 py-0 flex items-center justify-between">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-3">
          <Image
            src="/images/logos/moverz-logo.png"
            alt="Moverz"
            width={90}
            height={90}
            className="w-22 h-22"
          />
                  <div className="text-white font-bold tracking-tight text-lg md:text-xl leading-tight poppins-font">
                    <div>Devis</div>
                    <div>Demenageur</div>
                    <div>Toulousain</div>
                  </div>
